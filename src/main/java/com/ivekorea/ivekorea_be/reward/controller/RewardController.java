...
public class RewardController {
    ...
    @GetMapping("/callback")
    public ResponseEntity<String> iveAddList(@RequestParam(name = "ads_idx") Long adsIdx,
        ...
        return rewardService.saveIVEReward(adsIdx, userId, adsName, adsType,reward, mdaReward, key, hash);
    }
}
